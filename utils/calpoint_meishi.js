...
pointProvider.find({},{skip:454},function(err,result){
    if(err) throw err;
    if(result){
...
//                                commentNum:0,gradeSum:0,isLike:[],searchNum:0,activityType:0,
                                if(sss){
                                    var ccategory = '';
                                    if(curr.category=='日本'||curr.category=='韩国料理'||curr.category=='东南亚菜'||curr.category=='西餐'){
                                        ccategory = '异国美食';
                                    }else if(curr.category=='小吃快餐'){
                                        ccategory = '小吃快餐';
                                    } else{
                                        ccategory = '中餐';
                                    }

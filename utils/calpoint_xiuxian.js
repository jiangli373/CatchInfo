...
var $ = require('jquery');
var XiuXianPointProvider = require("../modules/XiuXianPointProvider").XiuXianPointProvider;
var pointProvider = new XiuXianPointProvider();
...
//                                commentNum:0,gradeSum:0,isLike:[],searchNum:0,activityType:0,
                                if(sss){
                                    var ccategory = '';
                                    if(curr.category=='咖啡厅'||curr.category=='酒吧'||curr.category=='茶馆'||curr.category=='ktv'||curr.category=='电影院'){
                                        ccategory = curr.category;
                                    }else if(curr.category=='游乐游艺'){
                                        ccategory = '网吧游艺';
                                    } else{
                                        ccategory = '其他';
                                    }

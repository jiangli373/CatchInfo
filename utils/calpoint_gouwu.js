...
var $ = require('jquery');
var GouWuPointProvider = require("../modules/GouWuPointProvider").GouWuPointProvider;
var pointProvider = new GouWuPointProvider();
...
pointProvider.find({},{skip:335},function(err,result){
    if(err) throw err;
    if(result){
...
//                                commentNum:0,gradeSum:0,isLike:[],searchNum:0,activityType:0,
                                if(sss){
                                    var ccategory = '';
                                    if(curr.category=='综合商场'){
                                        ccategory = '卖场';
                                    }else if(curr.category=='超市\/便利店'){
                                        ccategory = '超市\/便利店';
                                    } else{
                                        ccategory = '其他';
                                    }

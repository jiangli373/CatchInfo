...
var OtherPointProvider = require("../modules/OtherPointProvider").OtherPointProvider;
var otherPointProvider = new OtherPointProvider();
...
otherPointProvider.find({},{},function(err,result){
    if(err) throw err;
    if(result){
...
//                                commentNum:0,gradeSum:0,isLike:[],searchNum:0,activityType:0,
                                if(sss){
                                    var ccategory = '';
                                    if(curr.category=='更多亲子服务'){
                                        ccategory = '亲子服务';
                                    }else if(curr.category=='幼儿教育'){
                                        ccategory = '幼儿教育';
                                    } else if(curr.category=='亲子购物'){
                                        ccategory = '亲子购物';
                                    }else if(curr.category=='孕产护理'){
                                        ccategory = '孕产护理';
                                    }else if(curr.category=='亲子摄影'){
                                        ccategory = '亲子摄影';
                                    }else if(curr.category=='亲子游乐'){
                                        ccategory = '亲子游乐';
                                    }
                                    var json = {
                                        commentNum:0,
